...
if(isset($_POST['submit'])){
	...
	mysqli_query($con,"insert into `order`(user_id,address,city,pincode,user_name,contact,payment_type,payment_status,order_status,reference_code,added_on,total_price,txnid,coupon_id,coupon_code,coupon_value) values('$user_id','$address','$city','$pincode','$user_name','$contact','$payment_type','$payment_status','$order_status','$reference','$added_on','$total_price','$txnid','$coupon_id','$coupon_code','$coupon_value')");
									...
									<div class="accordion__body">
										...
										<div class="accordion__body">
											<div class="paymentinfo">
												...
												Gcash<input type="radio" name="payment_type" value="Gcash" id="chkYes"/>
												Pickup<input type="radio" name="payment_type" value="pickup"/>
												<div id="dvtext">
													Gcash Reference No:
													<input type="text" id="txtBox" name="reference" style="width: 150px"/>
												</div>
											</div>
										</div>
