...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><a href="order_master.php"><i class="fas fa-arrow-alt-circle-left" style="color:#fff"></i></a><strong style="color:#fff"> Update Order</strong></div>
						...
						<div id="address_details">
							...
							<div>
								<form method="post">
									...
									<input type="submit" class="form-control" style="backgroud-color: #17a2b8">
								</form>
							</div>
						</div>
				   </div>
