               ...
               <ul class="nav navbar-nav">
                  <li class="menu-title">Menu</li>             
                     <li class="menu-item-has-children dropdown">             
                        <a href="order_master.php"><span><i class="fas fa-coffee"></i>Orders</span></a>
                     </li>
                     <li class="menu-item-has-children dropdown">
                        <a href="reservation_master.php" ><span><i class="fas fa-chair"></i> Reservation</span></a>
                     </li>
                     <li class="menu-item-has-children dropdown">
                     ...
                     <li class="menu-item-has-children dropdown">
                        <a href="coupon_master.php" ><span><i class="fas fa-tag"></i> Coupon</span></a>
                     </li>
