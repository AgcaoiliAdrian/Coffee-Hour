...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2021 at 09:12 AM
...
(14, 5, 0, 'Matcha Frappe', 0, 120, 0, '176136078_matcha.jpg', 'Matcha flavored frappe', 'upgrade your summer with our new matcha frappe', 1, '', '', '', 1, 1),
(16, 7, 0, 'Dreamy Matcha', 0, 185, 0, '477447069_dreamy.jpg', 'Latest Product', 'Introducing Dreamy Matcha Cold Foam', 1, '', '', '', 1, 1);
...
CREATE TABLE `reservation` (
  `id` int(11) NOT NULL,
  `reserve_id` varchar(20) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE `reserve_status` (
  `id` int(11) NOT NULL,
  `reserve_name` varchar(21) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(3, 'Adrian', 'user1233', 'adrianagcaoili20@gmail.com', 0, '', '2021-06-01 04:35:48');
...
--
-- AUTO_INCREMENT for table `reserve_status`
--
ALTER TABLE `reserve_status`
